...
def heroi_pronto_por_nome(nomeheroi):
    ...
    with engine.connect() as con:
        ...
        resp = con.execute(statement, heroi = nomeheroi)
        nome_heroi = resp.fetchone()
        nome_heroi = dict(nome_heroi)
        nome_heroi['vida'] = nome_heroi['fisico'] * 10
        return nome_heroi
...
Um desses dicionarios vai representar a varinha: ter chaves "tipo" com valor "varinha" e chave "magia" com valor 2
